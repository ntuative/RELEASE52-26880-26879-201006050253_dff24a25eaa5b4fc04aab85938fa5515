package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1978 = parseInt(param1.@precedence);
         var_1976 = String(param1.@activepartset);
         var_1975 = String(param1.@assetpartdefinition);
         var_1977 = String(param1.@lay);
         var_590 = String(param1.@geometrytype);
         var_1688 = Boolean(parseInt(param1.@main));
         var_1979 = Boolean(parseInt(param1.@ObjectsMessageEvent));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "ObjectsMessageEvent")
            {
               var_1980 = _loc6_;
            }
            else
            {
               var_1520[_loc5_] = _loc6_;
            }
         }
      ...
      {
         return var_1262.concat(getTypePrevents(param1));
      }
