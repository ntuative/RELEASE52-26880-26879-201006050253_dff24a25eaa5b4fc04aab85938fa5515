package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_770:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1101:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_770 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1101 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_770)
         {
            var_770.removeListItems();
         }
         if(var_1101)
         {
            var_1101.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_770)
               {
                  var_770.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1101)
            {
               var_1101.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
