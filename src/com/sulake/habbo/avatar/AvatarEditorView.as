package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1664:IWindowContainer;
      
      public static var var_1429:IWindowContainer;
      
      public static var var_2332:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1047 = [];
         var_1137 = [AvatarEditorFigureCategory.const_676,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_236,AvatarEditorFigureCategory.const_655,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_97];
         super();
         var_29 = param1;
         ...
         if(var_1429 == null)
         {
            ...
            var_1429 = var_29.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1664 == null)
         {
            _loc8_ = var_29.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1664 = var_29.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1518 == AvatarEditorSideCategory.const_97 || var_1971))
         {
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1137);
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_743:
               break;
            case AvatarEditorSideCategory.const_492:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_492);
               break;
            case AvatarEditorSideCategory.const_97:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_97);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      {
         if(var_1518 == AvatarEditorSideCategory.const_97)
         {
            var_1971 = false;
            setSideContent(AvatarEditorSideCategory.const_743);
         }
         else
         {
