package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_345:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1054 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_345 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_345 && var_1054)
         {
            var_345.bitmap = new BitmapData(var_345.width,var_345.height,true,16777215);
            var_345.bitmap.copyPixels(var_1054,var_1054.rect,new Point(0,0 - 0 - 8));
            var_345.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
