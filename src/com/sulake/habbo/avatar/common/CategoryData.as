package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_743 >= 0 && var_177.length > var_743)
         {
            _loc2_ = var_177[var_743];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_202.length)
         {
            ...
            {
               if(_loc7_.length > var_202[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_202[param2],param2);
         var_202[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_202[param1])
         {
            return null;
         }
      ...
      {
         return var_177[var_743] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_202 = new Array(param1.length);
         var _loc3_:int = 0;
