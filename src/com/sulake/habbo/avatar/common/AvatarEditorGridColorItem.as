package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_723 = _loc6_.content as BitmapData;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_721.width,var_721.height,true,0);
            _loc1_.bitmap.copyPixels(var_721,var_721.rect,new Point(0,0));
         }
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_723.width,var_723.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_723,var_723.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(var_722)
            {
               switch(var_722.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_63:
                     _loc4_.style = HabboIconType.const_753;
                     _loc4_.visible = true;
                     break;
