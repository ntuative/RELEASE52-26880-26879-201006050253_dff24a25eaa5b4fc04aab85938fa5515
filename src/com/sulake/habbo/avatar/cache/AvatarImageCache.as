package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1455:int = 60000;
      ...
      private var var_966:IAvatarImage;
      ...
      {
         if(var_590 == param1 || var_590 == GeometryType.const_1036 && param1 == GeometryType.const_1044 || param1 == GeometryType.const_1036 && var_590 == GeometryType.const_1044)
         {
            var_590 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_758)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_412)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_81.getParts(param1,var_966.getFigure(),_loc6_,var_590,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_81.getCanvas(var_151,var_590);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1337[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               {
                  _loc33_ = var_81.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc30_ == AvatarAction.const_1022 || _loc30_ == AvatarAction.const_396) && (_loc6_ == AvatarBodyPartType.const_236 || _loc6_ == AvatarBodyPartType.const_1290 || _loc6_ == AvatarBodyPartType.const_1215) && _loc7_.color != null)
               {
               ...
               if(_loc22_)
               {
                  if(var_151 == AvatarScaleType.const_56)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_130 != null)
         {
            ...
            {
               _loc5_ = var_130.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
