package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_440:PartSetsData;
      
      private var var_1620:PartOffsetData;
      
      private var var_925:AvatarActionManager;
      
      private var var_183:IAssetLibrary;
      
      private var var_924:IAssetLibrary;
      
      private var var_2227:AvatarRenderManager;
      
      private var var_318:FigureData;
      
      private var var_606:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_777:String;
      
      private var var_1621:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_183 = param2;
         var_924 = param3;
         var_318 = new FigureData();
         var_440 = new PartSetsData();
         var_606 = new AnimationData();
         var_1621 = new AvatarStructureDownloadSet();
         var_778 = new AnimationManager();
         var_777 = param4;
         var_1620 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_925.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_925.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_318.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_925.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_778.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_440.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_440.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1278[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_925.getDefaultAction();
         var _loc9_:Array = var_440.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_778.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_318.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_318.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_606.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_440.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_440.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_777 + " ready to go!");
         if(var_777 == AvatarType.const_103)
         {
            var_440.getPartDefinition("ri").appendToFigure = true;
            var_440.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_777)
         {
            case AvatarType.const_103:
               ...
               var_1621.add(new AvatarStructureDownload(var_183,_loc5_,var_318));
               break;
            case AvatarType.PET:
         }
         var_1621.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_778.getAnimation(param1);
      }
      ...
      {
         var_925 = new AvatarActionManager(var_183,var_777);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1373 = var_318.getMandatorySetTypeIds();
         return var_1373;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_318.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_924.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_924.getAssetByName("dance" + _loc1_).content as XML;
            var_778.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_924.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_924.getAssetByName("fx" + _loc1_).content as XML;
            var_778.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_318.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_318.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1620.loadOffsets(var_924);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_925.sortActions(param1);
      }
   }
}
