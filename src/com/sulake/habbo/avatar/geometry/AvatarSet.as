package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1688 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_991 = new Dictionary();
         var_1449 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_991[String(_loc3_.@id)] = _loc5_;
         }
         for each(_loc4_ in param1.bodypart)
         {
            var_1449.push(String(_loc4_.@id));
         }
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1449.concat();
