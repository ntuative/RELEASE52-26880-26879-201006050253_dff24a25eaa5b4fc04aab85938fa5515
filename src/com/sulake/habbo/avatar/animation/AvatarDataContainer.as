package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1579:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_1778 = parseInt(_loc2_,16);
         var_1776 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1581,var_1583,var_1579,_alphaMultiplier);
         var_1013 = generatePaletteMapForGrayscale(var_1776,var_1778);
      }
