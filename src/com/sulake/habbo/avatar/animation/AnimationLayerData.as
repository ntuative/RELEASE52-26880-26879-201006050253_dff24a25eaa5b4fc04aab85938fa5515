package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_758:String = "bodypart";
      ...
      private var var_1639:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_2252 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1226 = parseInt(param2.@dy);
         var_1225 = parseInt(param2.@dz);
         var_1200 = parseInt(param2.@dd);
         _type = param3;
         ...
         if(param5 != null)
         {
            var_1639 = new ActiveActionData(param5.state,_loc7_);
            var_1639.definition = param5;
         }
      }
