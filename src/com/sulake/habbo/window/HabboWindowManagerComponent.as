package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1066:uint = 1;
       
      
      private var var_683:ISkinContainer;
      ...
      private var var_1185:ProfilerAgentTask;
      
      private var var_1188:IEventDispatcher;
      
      private var var_2436:uint = 0;
      
      private var var_1186:ProfilerAgentTask;
      
      private var var_1187:ProfilerOutput;
      
      private var var_684:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1188 = Component(param1).events;
         var_392 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_683 = new SkinContainer(_loc3_.content as XML,assets);
         var_684 = new WindowRenderer(var_683);
         var_220 = new Array(const_365);
         var _loc5_:int = 0;
         while(_loc5_ < const_365)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_684,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_220[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_241 = var_220[const_1066];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_241.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_241.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1399,_loc6_);
      }
      ...
      {
         return var_220[param1].getDesktopWindow().getChildAt(var_241.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1187 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1187 = new ProfilerOutput(_loc3_,this,var_684);
               var_1185 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1185);
      ...
      {
         return var_241.getWindowParser().windowToXMLString(param1);
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return var_683.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_978.length > 0)
         {
            var_1188.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_365 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1188.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_978.length > 0)
         {
            WindowContext.var_978.flush();
         }
         if(WindowContext.var_1428.length > 0)
         {
            WindowContext.var_1428.flush();
         }
         var_1188.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_241.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1431,new Date().getTime().toString());
