package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      private var var_445:IProfiler;
      
      private var var_2401:Array;
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_445.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_445.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_445.removeStopEventListener(refresh);
            var_445 = null;
            _windowManager = null;
            var_684 = null;
            _disposed = true;
