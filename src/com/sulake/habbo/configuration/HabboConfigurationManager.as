package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_512 = getKey("url_prefix");
         if(var_512 != null && false)
         {
            setKey("client.fatal.error.url",var_512 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1424);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1080[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_512 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_512.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1567.indexOf(param1) < 0)
         {
            var_1080[param1] = param2;
         }
      }
      ...
      {
         var _loc4_:String = var_1080[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_512);
      ...
      private function init() : void
      {
         ...
         if(!var_902)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_52,onConfigurationError);
         }
      }
