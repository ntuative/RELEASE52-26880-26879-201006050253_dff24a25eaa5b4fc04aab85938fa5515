package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         _main.events.addEventListener(HabboHelpTutorialEvent.const_500,onTaskDoneEvent);
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1021 = param2;
         var_1022 = param3;
         if(var_34 == null || var_34.id == const_93)
         {
            prepareForTutorial();
            showView(const_93);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_34 != null && (var_34.id == const_221 || var_34.id == const_93))
         {
            showView(const_93);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1588;
         _window.width = _loc2_.width + var_1587;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            ...
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_500,onTaskDoneEvent);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_419:
               var_1022 = true;
               if(var_34 != null && var_34.id == const_447)
               {
                  showView(const_93);
               }
               break;
            case HabboHelpTutorialEvent.const_500:
               if(var_34 != null && var_34.id == const_333)
               {
                  var_1217 = true;
                  disposeWindow();
               }
      ...
      {
         var_1023 = true;
         if(var_34 != null && (var_34.id == const_333 || var_34.id == const_93))
         {
            showView(const_93);
         }
      }
      ...
      {
         return var_1023 && var_1021 && var_1022;
      }
   }
}
