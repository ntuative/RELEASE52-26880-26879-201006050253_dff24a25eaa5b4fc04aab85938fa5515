package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_709:FaqCategory;
      ...
      {
         super();
         var_709 = new FaqCategory(-999,"${help.faq.title.urgent}");
      ...
      {
         var _loc4_:* = null;
         if(var_709.hasItem(param1))
         {
            var_709.getItem(param1).answerText = param2;
         }
