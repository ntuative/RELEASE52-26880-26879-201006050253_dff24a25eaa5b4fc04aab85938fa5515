package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_787:ITextFieldWindow;
      ...
      {
         var_787 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_787.procedure = onSearchInput;
         var_787.addEventListener(WindowKeyboardEvent.const_154,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_364.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_364.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_51.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_362,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:String, param4:String, param5:String, param6:Boolean, param7:Boolean, param8:Boolean, param9:int) : Boolean
      {
         ...
         _friendList.refreshButton(_loc10_,"ask_for_friend",param8,method_5,param9);
         return false;
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_787.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
