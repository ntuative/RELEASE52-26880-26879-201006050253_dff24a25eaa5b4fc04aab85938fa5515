package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1479:OpenedToWebPopup;
      
      private var var_831:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_413:FriendListTabs;
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_343.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_343.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_413.findTab(FriendListTab.const_90).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_343 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_91.addCategory(new FriendCategory(FriendCategory.const_875,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_509,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_91.addFriend(new Friend(_loc4_));
         }
         var_413 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_484)
         {
            var_484 = new Timer(120000);
            var_484.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_484.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_484.stop();
            var_484.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_484 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_831)
         {
            var_831.release(new IIDAvatarRenderManager());
            var_831 = null;
         }
         if(var_830)
         {
            var_830.release(new IIDHabboNotifications());
            var_830 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_577)
         {
            var_577.release(new IIDSessionDataManager());
            var_577 = null;
         }
         super.dispose();
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_413.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1478.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_343.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_577.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_577.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_343.limit)
         {
            var_343.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_413.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_831.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_343.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_413.findTab(FriendListTab.const_90);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1479 == null)
         {
            var_1479 = new OpenedToWebPopup(this);
         }
         var_1479.show(x,y);
      }
