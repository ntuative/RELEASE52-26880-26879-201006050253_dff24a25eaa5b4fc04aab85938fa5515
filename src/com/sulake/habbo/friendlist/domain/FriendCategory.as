package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_309:int = 100;
      ...
      {
         return Math.ceil(this.var_244.length / const_309);
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_950 + 1) * const_309,this.var_244.length);
      }
