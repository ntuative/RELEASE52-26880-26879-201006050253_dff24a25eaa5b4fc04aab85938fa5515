package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1682:int = "F".charCodeAt(0);
      
      public static const const_1564:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_642 = param1.gender;
         var_703 = param1.online;
         var_1171 = param1.followingAllowed && param1.online;
         var_451 = param1.figure;
         var_1170 = param1.motto;
         var_1169 = param1.lastAccess;
         var_1172 = param1.categoryId;
         var_1168 = param1.realName;
