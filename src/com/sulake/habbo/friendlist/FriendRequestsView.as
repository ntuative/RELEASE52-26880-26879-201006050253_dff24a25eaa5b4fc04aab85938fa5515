package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_349 && _loc4_.state != FriendRequest.const_335)
            {
      ...
      {
         var_1641 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1640 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1640.procedure = onDismissAllButtonClick;
         var_1641.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_349 && _loc4_.state != FriendRequest.const_335)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_279,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1003)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1641,_loc1_);
         setEnabled(var_1640,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_279,param1));
         }
      }
   }
}
