package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_814:int = 100;
       
      
      private var var_2191:IScrollbarWindow;
      
      private var var_133:HabboMessenger;
      
      private var var_1617:IContainerButtonWindow;
      
      private var var_524:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_133 = param1;
         var_1617 = initButton("follow_friend",onFollowButtonClick,param2);
         var_51 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2191 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_572 || param3.type == Message.const_696 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_524.messages.length - const_814);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_524.messages.length)
         {
            refreshEntry(true,_loc1_,var_524.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_524 == null || _loc1_.id != var_524.id)
         {
            var_524 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_814 + const_1139)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.send(new FollowFriendMessageComposer(var_524.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1140;
         param1.invalidate();
      }
   }
}
