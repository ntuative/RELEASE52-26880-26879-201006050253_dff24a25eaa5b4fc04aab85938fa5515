package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      {
         super();
         var_1293 = getTimer() + getBlinkInterval();
      }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(var_1073 > 0)
         {
            ...
            else if(var_616 == 0 && var_508 == 0)
            {
               var_508 = param1 + getTalkingPauseInterval();
               var_616 = var_508 + getTalkingPauseLength();
            }
            else if(var_508 > 0 && param1 > var_508)
            {
               param2.setNumber(RoomObjectVariableEnum.const_227,0);
               var_508 = 0;
            }
            else if(var_616 > 0 && param1 > var_616)
            {
         ...
         if(var_1072 > 0 && param1 > var_1072)
         {
            param2.setNumber(RoomObjectVariableEnum.const_276,0);
            var_1072 = 0;
         }
         if(var_1071 > 0 && param1 > var_1071)
         {
         ...
         if(param1 > var_1293)
         {
            param2.setNumber(RoomObjectVariableEnum.const_631,1);
            var_1293 = param1 + getBlinkInterval();
            var_1074 = param1 + getBlinkLength();
         }
         if(var_1074 > 0 && param1 > var_1074)
         {
         ...
         if(_selected && object != null)
         {
            if(eventDispatcher != null)
            {
               ...
               if(var_355 == null || var_355.x != _loc2_.x || var_355.y != _loc2_.y || var_355.z != _loc2_.z)
               {
                  ...
                  _loc3_ = new RoomObjectMoveEvent(RoomObjectMoveEvent.const_381,object.getId(),object.getType());
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_387,_loc5_.postureType);
            _loc2_.setString(RoomObjectVariableEnum.const_646,_loc5_.parameter);
            return;
         }
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            var_1073 = getTimer() + _loc6_.numberOfWords * 1000;
            return;
         }
         if(param1 is RoomObjectAvatarTypingUpdateMessage)
         {
            _loc7_ = param1 as RoomObjectAvatarTypingUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_879,Number(_loc7_.isTyping));
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc8_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_339,_loc8_.dirHead);
            return;
         }
         if(param1 is RoomObjectAvatarGestureUpdateMessage)
         {
            _loc9_ = param1 as RoomObjectAvatarGestureUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_276,_loc9_.gesture);
            var_1072 = getTimer() + 3000;
            return;
         }
         if(param1 is RoomObjectAvatarWaveUpdateMessage)
         {
            ...
            {
               _loc2_.setNumber(RoomObjectVariableEnum.const_212,0);
               var_745 = 0;
            }
            return;
         }
         if(param1 is RoomObjectAvatarDanceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_948,_loc11_.danceStyle);
            return;
         }
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            _loc12_ = param1 as RoomObjectAvatarSleepUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_463,Number(_loc12_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_301,_loc15_.itemType);
            return;
         }
         if(param1 is RoomObjectAvatarSignUpdateMessage)
         {
            ...
            var_1071 = getTimer() + 5000;
            return;
         }
         if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
         {
            _loc17_ = param1 as RoomObjectAvatarFlatControlUpdateMessage;
            _loc2_.setString(RoomObjectVariableEnum.const_670,_loc17_.rawData);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1219,Number(_loc17_.isAdmin));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc18_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc19_ = _loc2_.getString(RoomObjectVariableEnum.const_178);
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_178,_loc20_);
            _loc2_.setString(RoomObjectVariableEnum.const_881,_loc21_);
            return;
         }
