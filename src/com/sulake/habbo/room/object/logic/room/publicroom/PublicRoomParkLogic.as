package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1125:String = "bus_oviopen_hidden";
      
      private static const const_1127:String = "goawaybus";
      
      private static const const_1126:String = "bus";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1127:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_469,0,_loc4_,_loc5_);
                     break;
                  case const_1126:
                  case const_1125:
