package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_345:int = 1000;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1223 / 2) % 360 / var_1223;
         ...
         {
            _loc6_ = int(var_225.getKey(_loc5_)) * var_1223;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_949);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_998);
                  break;
               case "DARKEN":
