package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1065[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1066[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1065 = new Array();
         var_1065.push(Math.random() * _loc2_ * 1.5);
         var_1065.push(Math.random() * _loc2_ * 1.5);
         var_1067 = new Array();
         var_1067.push(1);
         var_1067.push(-1);
         var_1068 = new Array();
         var_1068.push(const_1124);
         var_1068.push(const_1123);
         var_1066 = new Array();
         var_1066.push(getRandomAmplitudeFactor());
         var_1066.push(getRandomAmplitudeFactor());
      }
