package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1090:Point = null;
      
      private var var_519:Array;
      
      private var var_1091:LayoutRasterizerData = null;
      ...
      private var var_921:IGraphicAssetCollection;
      
      private var var_1318:XMLList;
      ...
      {
         var_518 = true;
         var _loc3_:int = var_363.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_363.push(param1);
            var_517.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1092 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_760);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1327 = RoomObjectVariableEnum.const_960;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1327 = RoomObjectVariableEnum.const_1009;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1092 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1092 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         if(param2 == var_2126 && param3 == var_2128)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1092 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1092 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1327);
         }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_760)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1091 = var_40.getValue(var_760);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_760);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1091.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_921.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1090.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1090.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_363.indexOf(_loc10_) >= 0 && var_518)
            {
               param1 = var_363.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_921.getAsset(var_517[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_519[param1];
               }
               var_363.splice(param1,1);
               var_517.splice(param1,1);
               var_519.splice(param1,1);
               if(false)
               {
                  var_518 = false;
               }
