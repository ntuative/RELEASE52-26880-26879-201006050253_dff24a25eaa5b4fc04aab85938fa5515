package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_819:String = "tile_cursor";
      ...
      private static const const_1146:String = const_375;
      ...
      public static const const_694:String = "RCL_LOADER_READY";
      ...
      private var var_1105:IEventDispatcher = null;
      
      private var var_1364:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_529 = [];
         _wallItems = [];
         var_2212 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2215 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_150 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_438 != null)
         {
            _loc2_ = var_438.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_379.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_181 != null && var_181.hasWorldType(const_298 + param1))
         {
            return var_181.type;
         }
         return param1;
      ...
      {
         return [const_375,const_522,ROOM_CONTENT,const_819,const_818];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_34 || _loc2_ == RoomObjectCategoryEnum.const_32)
         {
            ...
            return int(var_527.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2212.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_192 && _loc5_ != RoomObjectLogicEnum.const_150)
         {
            _loc6_ = "@shadow";
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_629.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_472,_loc5_);
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_437 != null)
         {
            _loc2_ = var_437.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1326);
               return;
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_274;
         }
         return RoomObjectCategoryEnum.const_240;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2210)
         {
            ...
            if(var_1105 != null)
            {
               var_1105.dispatchEvent(new Event(const_694));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_181 != null)
         {
            return var_181.getWorldHeightScale(const_298 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_629.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_528.add(_loc3_,_loc4_);
               if(var_529.indexOf(_loc7_) < 0)
               {
                  var_529.push(_loc7_);
               }
            }
            ...
            _loc8_ = var_527.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_527.remove(_loc7_);
               var_527.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1105 = param1;
         var_2209 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2211 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2213 = param2.getKey("public.room.dynamic.download.url","");
         var_2214 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_37 = const_817;
         initFurniData();
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_437 != null)
         {
            var_437.remove(param1);
            var_437.add(param1,param2);
         }
         if(var_438 != null)
         {
            var_438.remove(param2);
            var_438.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_192 && _loc5_ != RoomObjectVisualizationEnum.const_150)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1364.getValue(param1) != null)
         {
            var_181 = var_1364.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_181 != null)
         {
            return var_181.getWorldScale(const_298 + param1);
         }
         return 32;
      }
   }
