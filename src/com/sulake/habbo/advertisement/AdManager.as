package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_918:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_494,0,0,_loc4_,var_1615,var_918,var_919));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2179 = int(_config.getKey("interstitial.interval","30000"));
         var_2178 = int(_config.getKey("interstitial.show.time","5000"));
         var_1613 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1353 = _loc2_.imageUrl;
         var_1615 = _loc2_.clickUrl;
         if(var_1353 != "" && var_1615 != "")
         {
            _loc3_ = var_1353;
            ...
            _loc4_ = new URLRequest(var_1353);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1352 = _loc2_.imageUrl;
         var_2177 = _loc2_.clickUrl;
         var_771 = getTimer();
         if(var_1352 != "")
         {
            _loc3_ = var_1352;
            ...
            var_238.start();
            _loc4_ = new URLRequest(var_1352);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_36,interstitialLoaderEventHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_52,interstitialLoaderEventHandler);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_479,0,0,param1.bitmapData,var_2177));
            var_771 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_919 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1613 > 0 && var_1614 >= var_1613)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_771;
         if(_loc1_ > var_2179)
         {
            ++var_1614;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_478));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_918 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
