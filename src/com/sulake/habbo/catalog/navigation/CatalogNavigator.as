package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2430:String = "magic.pixels";
      
      private var var_2431:String = "catalog.page.club";
      
      private var var_2454:String = "magic.credits";
      ...
      {
         _catalog.openCatalogPage(var_2431,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_286.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = var_286.indexOf(_loc6_);
            var_286.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).method_4(var_51);
            }
         }
      }
