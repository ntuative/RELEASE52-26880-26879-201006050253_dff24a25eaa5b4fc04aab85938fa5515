package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1396:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_850:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1444 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1444) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_943);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1434) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1404) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1420) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1406) as IWindowContainer;
         if(_loc1_ != null)
         {
            var_56.push(new RecyclerCatalogWidget(_loc1_));
         }
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1409) as IWindowContainer;
         if(_loc1_ != null)
         {
            var_56.push(new RecyclerPrizesCatalogWidget(_loc1_));
         }
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1437) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1396;
            _loc2_.init();
         }
         var_1396.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1396.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_943);
      }
