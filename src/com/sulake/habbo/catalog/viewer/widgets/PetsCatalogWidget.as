package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IAvatarImageListener
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:IBreed = var_587[var_1491] as IBreed;
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_139,onTextWindowEvent);
         var_619 = new Map();
         ...
         var_845 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_299 = [];
         var_587 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_845,this);
               if(_loc11_)
               {
                  var_587 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_587.length)
         {
            _loc12_ = var_587[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_845,_loc12_.id),getRaceLocalizationKey(var_845,_loc12_.id)));
            _loc6_++;
         }
         var_619.add(var_845,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_841,onApproveNameResult);
         _loc5_ = var_619.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_619.getWithIndex(0),page,p);
      }
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_619.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         var _loc3_:IBreed = var_587[var_1491] as IBreed;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_845,_loc3_.id,_loc2_,AvatarScaleType.const_56,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_250,AvatarAction.const_596);
