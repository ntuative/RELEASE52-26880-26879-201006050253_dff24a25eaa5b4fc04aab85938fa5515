package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1231:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1193.text = "${" + _loc3_.name + "}";
            var_1194.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1193.text = "${" + _loc2_.localizationId + "}";
            var_1194.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_454:
                  _loc4_ = var_1232.clone();
                  if(var_585 != null)
                  {
                     var_585.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_585,var_1231,var_1236);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_238:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_250,AvatarAction.const_401);
                              _loc13_.appendAction(AvatarAction.const_480,_loc6_.productClassId);
      ...
      {
         var_1193 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1194 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1489 = new Point(var_83.x,var_83.y);
         var_585 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1231 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_585 == null)
         {
         ...
         var_1232 = _loc2_.content as BitmapData;
