package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1039 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1039 != null)
         {
            var_1039.addEventListener(WindowKeyboardEvent.const_599,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1039.text));
      }
   }
}
