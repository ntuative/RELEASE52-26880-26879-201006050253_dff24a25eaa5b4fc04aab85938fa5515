package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_905:MarketPlaceOfferData;
      
      private const const_1461:int = 1;
      
      private const const_1729:int = 40;
      ...
      private const const_1730:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_514)
         {
            ...
            var_514 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_514)
         {
            return;
         ...
         updateStatusDisplay(const_1460,_loc2_.length);
         if(!var_424)
         {
            var_424 = new Timer(25);
            var_424.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_904 = 0;
         populateList();
         var_424.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_619)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_514 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_514.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1461);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_425.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_424)
         {
            var_424.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_424 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_904 >= var_619.length)
            {
               return true;
            }
            addListItem(var_619.getWithIndex(var_904));
            ++var_904;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_905.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_139)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_425));
            _loc7_.selection = 0;
         }
      }
