package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1030:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1029 != null)
         {
            var_1029.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1030 != null)
         {
            var_1030.removeEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1029 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1029 != null)
         {
            var_1029.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1030 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1030 != null)
         {
            var_1030.addEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
