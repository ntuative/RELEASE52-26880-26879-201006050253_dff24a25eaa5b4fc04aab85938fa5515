package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1166:String = "ObjectsMessageEvent";
      ...
      private var var_1164:String = "1.1";
      ...
      private var _floorType:String = "ObjectsMessageEvent";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_274 != null && var_275 != null)
         {
            setRoomImage(var_274,var_275);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_196:
               ...
               if(var_313 >= _activeFloorPatterns.length)
               {
                  var_313 = 0;
               }
               var_276 = 0;
               ...
               for each(_loc9_ in var_147.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_755 = _loc9_.children().length();
                  }
               }
            ...
            case const_89:
               ...
               for each(_loc10_ in var_147.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_756 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1166,var_1164,64,this,"window_romantic_wide");
