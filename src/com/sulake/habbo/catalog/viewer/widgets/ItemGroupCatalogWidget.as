package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_641[var_1132] as Array;
      ...
      {
         var _loc2_:Offer = var_641[var_1132][var_2286];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_473 || _loc1_.pricingModel == Offer.const_439)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_83 || _loc3_.productType == ProductTypeEnum.const_86)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1131.indexOf(_loc5_) == -1)
                        {
                           var_1131.push(_loc5_);
                           var_641.push(new Array());
                        }
                        _loc6_ = var_1131.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_641)
         {
            if(var_2286 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2286] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1132 = var_985.getGridItemIndex(param1.view);
