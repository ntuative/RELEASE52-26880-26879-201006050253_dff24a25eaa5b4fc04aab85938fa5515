package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_328 != null)
         {
            _loc2_ = var_328.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1268 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_328 = null;
         for each(_loc1_ in var_1269)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1268) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = var_721.width;
            _loc2_.height = var_721.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_721.width,var_721.height,true,0);
               _loc3_.bitmap.copyPixels(var_721,var_721.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_723.width,var_723.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_723,var_723.rect,new Point(0,0),null,null,true);
