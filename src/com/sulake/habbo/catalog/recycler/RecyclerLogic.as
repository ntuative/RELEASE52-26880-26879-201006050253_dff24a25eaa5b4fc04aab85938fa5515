package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1477)
         {
            case RecyclerStatusMessageEvent.const_1270:
               var_254 = const_371;
               if(_view == null)
               {
                  return;
      ...
      {
         return var_1477 != RecyclerStatusMessageEvent.const_885;
      }
      
      private function get statusActive() : Boolean
      {
         return var_254 != const_780;
      }
      ...
      {
         return active && var_254 == const_371;
      }
