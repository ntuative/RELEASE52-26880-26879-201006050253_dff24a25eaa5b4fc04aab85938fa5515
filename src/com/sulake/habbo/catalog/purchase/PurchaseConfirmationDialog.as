package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1463:uint = 4.294967295E9;
      
      private const const_1462:uint = 4.293848814E9;
      
      private var var_877:int;
      
      private const const_1725:uint = 4.291613146E9;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_878;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_878,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1462) : uint(const_1463);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1538;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_86);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_450,var_79,var_1055);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_878);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_610[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_611[var_200]);
         _catalog.purchaseProductAsGift(var_450,var_79,var_1055,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_139:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_2015 == _loc3_.text)
               {
                  return;
               }
            ...
            case WindowMouseEvent.const_55:
               ...
               break;
            case WindowKeyboardEvent.const_599:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_83:
                  ...
                  break;
               case ProductTypeEnum.const_238:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1538 = _loc1_.stuffTypes;
            var_610 = _loc1_.boxTypes;
            var_611 = _loc1_.ribbonTypes;
            var_878 = var_1538[0];
            _boxIndex = var_610[0];
            var_200 = var_611[0];
            initColorGrid();
