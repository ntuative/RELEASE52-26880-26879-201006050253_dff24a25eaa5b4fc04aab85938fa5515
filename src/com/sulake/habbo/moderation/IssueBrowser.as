package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1721:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1720:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1502:IIssueBrowserView;
      
      private const const_1747:String = "closed_issues";
      ...
      private var var_1501:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_346.view.width = var_228.container.width;
         var_346.view.height = var_228.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1719:
               if(var_1502 == null)
               {
                  var_1502 = new MyIssuesView(issueManager,this,var_228.container);
               }
               return var_1502;
            case const_1721:
               if(var_1500 == null)
               {
                  var_1500 = new OpenIssuesView(issueManager,this,var_228.container);
               }
               return var_1500;
            case const_1720:
               if(var_1501 == null)
               {
                  var_1501 = new PickedIssuesView(issueManager,this,var_228.container);
               }
               return var_1501;
            default:
               return null;
