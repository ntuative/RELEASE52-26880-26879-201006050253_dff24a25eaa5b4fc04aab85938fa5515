package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_686:OffenceCategoryData;
      ...
      private var var_685:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_817 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_818 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModBanMessageComposer(var_1189,var_393.text,getBanLength(),var_1190));
         this.dispose();
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1189,var_393.text,var_1190));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_686 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1189,var_393.text,var_1190));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_686 != null;
         if(this.var_685 != null)
         {
            var_55.findChildByName("offence_txt").caption = this.var_685.name;
            var_55.findChildByName("offence_category").visible = true;
         }
         else if(this.var_686 != null)
         {
            this.refreshButtons("offences_cont",2,var_686.offences,var_817,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_818,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_685 = var_686.offences[_loc3_];
         var_393.text = var_685.msg;
         var_298 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_55.caption = "Mod action on: " + var_1464;
         ...
         var_816 = IDropMenuWindow(var_55.findChildByName("banLengthSelect"));
