package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1086:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_426 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_1086 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_426.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_119.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1086.load(_loc4_,var_119.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_62,WindowTracker.const_863,_loc2_),_window,false,false,true);
      }
