package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_900:String = "issue_bundle_open";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_140 = new Map();
         var_910 = new Map();
         var_623 = new IssueBrowser(this,var_62.windowManager,var_62.assets);
         var_762 = [];
         var_911 = [];
         var_1093 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1093.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_762 = var_762.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_910.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_910.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1280)
         {
            var_160.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_140)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_910.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_910.add(param1.issueId,_loc2_);
         ...
         if(var_762.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_148)
         {
            ...
            _loc8_ = var_911.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1093.remove(param1);
         var_1093.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_1093.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_62.soundManager.playSound(HabboSoundTypesEnum.const_832);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_910.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_140.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
