package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1101:int = -16;
      
      private static const const_782:int = 32;
      
      private static const const_1102:int = 8;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1101,_loc4_.y + const_1100 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1908[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_42,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_857.getImage(ThumbnailEditorModel.const_42,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_857.getImage(ThumbnailEditorModel.const_59,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_782 + _loc3_,param2 * const_1102);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1246 == null)
         {
            var_1246 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1246,var_1246.rect,new Point(0,0),null,null,true);
      }
   }
}
