package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1453:CutToHeight = new CutToHeight();
      
      private static var var_1454:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1453.beforeSearch(param2,param1,param3);
         binarySearch(var_1453,param2.length - 1);
      }
