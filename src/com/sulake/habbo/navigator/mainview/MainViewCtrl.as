package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_521:int = 2;
      
      private static const const_810:int = 1;
      ...
      private static const const_811:int = 3;
      ...
      private function prepare() : void
      {
         ...
         var_228 = ITabContextWindow(var_15.findChildByName("tab_context"));
         var_20 = IWindowContainer(var_15.findChildByName("tab_content"));
         var_237 = IWindowContainer(var_15.findChildByName("custom_content"));
         var_208 = IWindowContainer(var_15.findChildByName("list_content"));
         var_281 = IWindowContainer(var_15.findChildByName("custom_footer"));
         var_1341 = var_15.findChildByName("loading_text");
         var _loc1_:IWindow = var_15.findChildByTag("close");
         _loc1_.procedure = onWindowClose;
         var_1338 = IRegionWindow(var_15.findChildByName("to_hotel_view"));
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_1308,true);
      }
      ...
      public function open() : void
      {
         ...
         if(_loc1_)
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,var_15));
         }
      }
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = _navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(var_281);
         if(Util.hasVisibleChildren(var_281))
         {
      ...
      public function refresh() : void
      {
         ...
         var_208.height = var_208.height + _loc1_ - 0 - 0 + var_2165;
         Util.moveChildrenToColumn(var_20,["list_content","custom_footer"],var_208.y,8);
         var_2165 = var_281.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_430 == const_810)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_208.blend - _loc2_));
            this.var_208.blend = _loc3_;
            this.var_237.blend = !!var_1339 ? Number(_loc3_) : Number(1);
            this.var_281.blend = !!var_1339 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_430 = const_521;
            }
         }
         else if(var_430 == const_521)
         {
            if(var_1340 % 10 == 1)
            {
