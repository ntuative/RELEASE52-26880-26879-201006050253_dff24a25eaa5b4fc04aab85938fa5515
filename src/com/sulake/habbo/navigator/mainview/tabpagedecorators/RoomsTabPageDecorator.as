package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_290,Tabs.const_322);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_290,Tabs.const_750);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_290,Tabs.const_322,"" + _loc3_);
         }
      }
