package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_822:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_480 = new Timer(100);
         var_480.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1009 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_480)
         {
            var_480.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_480.reset();
            var_480 = null;
         }
      }
      ...
      {
         var_1009.goBackToInitialState();
         var_1009.input.textBackgroundColor = 4294967295;
         var_822 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_43,HabboWindowParam.const_73,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1009.getText();
      ...
      {
         var _loc1_:Boolean = var_1009.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_822.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1192 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1192 = true;
            _loc3_.y = 1;
