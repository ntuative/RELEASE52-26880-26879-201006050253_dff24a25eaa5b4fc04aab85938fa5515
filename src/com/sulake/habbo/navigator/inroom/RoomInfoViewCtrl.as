package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomInfoViewCtrl implements IRoomSettingsCtrlOwner
   {
      ...
      private var var_203:RoomSettingsCtrl;
      ...
      private var var_1561:IWindowContainer;
      ...
      public function RoomInfoViewCtrl(param1:HabboNavigator)
      {
         ...
         var_203 = new RoomSettingsCtrl(_navigator,this,true);
         var_270 = new RoomThumbnailCtrl(_navigator);
         var_960 = new TagRenderer(_navigator);
         _navigator.roomSettingsCtrls.push(this.var_203);
      ...
      private function refreshEventButtons(param1:RoomEventData) : void
      {
         ...
         var_1560.visible = param1 == null && _navigator.data.currentRoomOwner;
         var_1562.visible = param1 != null && (_navigator.data.currentRoomOwner || _navigator.data.eventMod);
         var_1561.visible = Util.hasVisibleChildren(var_1561);
      }
      ...
      private function refreshRoomDetails(param1:GuestRoomData, param2:Boolean) : void
      {
         ...
         var_761.text = param1.roomName;
         var_761.height = NaN;
         _ownerName.text = param1.ownerName;
         var_898.text = param1.description;
         var_960.refreshTags(var_357,param1.tags);
         ...
         Util.moveChildrenToColumn(var_357,["room_name","owner_name_cont","tags","room_desc","rating_cont"],var_761.y,0);
      ...
      {
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_446,HabboToolbarIconEnum.ROOMINFO,_window,false));
      }
      ...
      private function refreshRoomButtons(param1:Boolean) : void
      {
         ...
         var_1295.visible = _navigator.data.canAddFavourite && !_loc2_;
         var_1296.visible = _navigator.data.canAddFavourite && _loc2_;
         var_1297.visible = _navigator.data.canEditRoomSettings && !param1;
         var_1294.visible = _navigator.data.canEditRoomSettings && param1;
         var_1299.visible = Util.hasVisibleChildren(var_1299);
      }
      ...
      private function refreshRoom() : void
      {
         ...
         this.var_203.refresh(var_308);
         this.var_270.refresh(var_308);
      ...
      private function refreshEvent() : void
      {
         ...
         this.var_356.refresh(var_271);
         if(Util.hasVisibleChildren(var_271) && !this.var_270.active)
         {
            Util.moveChildrenToColumn(var_271,["event_details","event_buttons"],0,2);
      ...
      private function refreshPublicSpaceDetails(param1:PublicRoomShortData) : void
      {
         ...
         var_1300.height = NaN;
         Util.moveChildrenToColumn(var_747,["public_space_name","public_space_desc"],var_1076.y,0);
      ...
      private function prepareWindow() : void
      {
         ...
         var_2074 = IWindowContainer(find("owner_name_cont"));
         var_2077 = IWindowContainer(find("rating_cont"));
         var_1299 = IWindowContainer(find("room_buttons"));
         var_761 = ITextWindow(find("room_name"));
         var_1076 = ITextWindow(find("public_space_name"));
         _ownerName = ITextWindow(find("owner_name"));
         var_898 = ITextWindow(find("room_desc"));
         var_1300 = ITextWindow(find("public_space_desc"));
         var_1075 = ITextWindow(find("owner_caption"));
         var_897 = ITextWindow(find("rating_caption"));
         var_2075 = ITextWindow(find("rate_caption"));
         var_1563 = ITextWindow(find("rating_txt"));
         var_271 = IWindowContainer(find("event_info"));
         var_899 = IWindowContainer(find("event_details"));
         var_1561 = IWindowContainer(find("event_buttons"));
         var_2076 = ITextWindow(find("event_name"));
         var_746 = ITextWindow(find("event_desc"));
         var_1295 = IContainerButtonWindow(find("add_favourite_button"));
         var_1296 = IContainerButtonWindow(find("rem_favourite_button"));
         var_1297 = IContainerButtonWindow(find("make_home_button"));
         var_1294 = IContainerButtonWindow(find("unmake_home_button"));
         var_1564 = IButtonWindow(find("room_settings_button"));
         var_1560 = IButtonWindow(find("create_event_button"));
         var_1562 = IButtonWindow(find("edit_event_button"));
         var_900 = IWindowContainer(find("embed_info"));
         var_1298 = ITextWindow(find("embed_info_txt"));
         var_1077 = ITextFieldWindow(find("embed_src_txt"));
         Util.setProcDirectly(var_1295,onAddFavouriteClick);
         Util.setProcDirectly(var_1296,onRemoveFavouriteClick);
         Util.setProcDirectly(var_1564,onRoomSettingsClick);
         Util.setProcDirectly(var_1297,onMakeHomeClick);
         Util.setProcDirectly(var_1294,onUnmakeHomeClick);
         Util.setProcDirectly(var_1560,onEventSettingsClick);
         Util.setProcDirectly(var_1562,onEventSettingsClick);
         Util.setProcDirectly(var_1077,onEmbedSrcClick);
         _navigator.refreshButton(var_1295,"favourite",true,null,0);
         _navigator.refreshButton(var_1296,"favourite",true,null,0);
         _navigator.refreshButton(var_1297,"home",true,null,0);
         _navigator.refreshButton(var_1294,"home",true,null,0);
         _window.findChildByName("close").procedure = onCloseButtonClick;
         Util.setProcDirectly(var_308,onHover);
         Util.setProcDirectly(var_271,onHover);
         var_1075.width = var_1075.textWidth;
         Util.moveChildrenToRow(var_2074,["owner_caption","owner_name"],var_1075.x,var_1075.y,3);
         var_897.width = var_897.textWidth;
         Util.moveChildrenToRow(var_2077,["rating_caption","rating_txt"],var_897.x,var_897.y,3);
         var_1298.height = NaN;
         Util.moveChildrenToColumn(var_900,["embed_info_txt","embed_src_txt"],var_1298.y,2);
         var_900.height = Util.getLowestPoint(var_900) + 5;
         var_2392 = NaN;
      }
      ...
      private function refreshEventDetails(param1:RoomEventData) : void
      {
         ...
         var_2076.text = param1.eventName;
         var_746.text = param1.eventDescription;
         var_960.refreshTags(var_899,[_navigator.getText("roomevent_type_" + param1.eventType),param1.tags[0],param1.tags[1]]);
         var_746.visible = false;
         if(param1.eventDescription != "")
         {
            var_746.height = NaN;
            var_746.y = Util.getLowestPoint(var_899) + 2;
            var_746.visible = true;
         }
         var_899.visible = true;
         var_899.height = Util.getLowestPoint(var_899);
      }
      ...
      {
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_860,HabboToolbarIconEnum.ROOMINFO,_window,false));
         if(_window == null)
         {
            return;
         }
