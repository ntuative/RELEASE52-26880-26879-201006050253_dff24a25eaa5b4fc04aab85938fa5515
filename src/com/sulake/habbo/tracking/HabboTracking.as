package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_827:uint = 11;
      ...
      private var var_553:FramerateTracker = null;
      
      private var var_268:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_1422:CoreComponent;
      
      private var var_162:IHabboHelp;
      
      private var var_1145:int = -1;
      
      private var var_968:LagWarningLogger = null;
      
      private var var_967:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_248 = new PerformanceTracker();
         var_553 = new FramerateTracker();
         var_247 = new LatencyTracker();
         var_968 = new LagWarningLogger();
         var_1423 = new Array(const_827);
         var _loc4_:int = 0;
         while(_loc4_ < const_827)
         {
            var_1423[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1435,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1199,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_580,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1033,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1411);
               break;
            case HabboCommunicationEvent.const_652:
               trackLoginStep(HabboLoginTrackingStep.const_1299,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_248 != null)
            {
               var_248.connection = param1;
            }
            if(var_247 != null)
            {
               var_247.communication = _communication;
               var_247.connection = param1;
            }
            if(var_968 != null)
            {
               var_968.connection = param1;
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_147)
         {
            Component(var_147).events.addEventListener(HabboConfigurationEvent.const_179,onConfigurationLoaded);
            if(var_247 != null)
            {
               var_247.configuration = var_147;
            }
            if(var_248 != null)
            {
               var_248.configuration = var_147;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_268.events.addEventListener(AdEvent.const_494,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2321)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1428);
            var_2321 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1033,String(_loc2_.guestRoomId));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_967)
            {
               var_967.release(new IIDHabboWindowManager());
               var_967 = null;
            }
            if(var_268)
            {
            ...
            if(var_187)
            {
               if(true)
               {
                  Component(var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_187).events.removeEventListener(HabboFriendListTrackingEvent.const_308,onFriendlistTrackingEvent);
               }
               var_187.release(new IIDHabboFriendList());
               var_187 = null;
            }
            if(var_162)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_652,onConnectionEvent);
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_147)
         {
            if(var_968 != null)
            {
               var_968.configure(var_147);
            }
            if(var_553 != null)
            {
               var_553.configure(var_147);
            }
            Component(var_147).events.removeEventListener(HabboConfigurationEvent.const_179,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_929);
         if(var_1422 != null)
         {
            var_1422.events.removeEventListener(HabboLoginTrackingStep.const_929,onCoreRunning);
         }
      }
      ...
      {
         var_967 = IHabboWindowManager(param2);
         if(var_967)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1145 > -1 && _loc2_ < var_1145)
         {
            ++var_1661;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1661);
         }
         if(var_1145 > -1 && _loc2_ - var_1145 > 15000)
         {
            ++var_1662;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1662);
         }
         var_1145 = _loc2_;
         if(var_248 != null)
         {
            var_248.update(param1);
         }
         if(var_247 != null)
         {
            var_247.update(param1);
         }
         if(var_553 != null)
         {
            var_553.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_147 != null && !Boolean(var_147.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         var_187 = param2 as IHabboFriendList;
         Component(var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_187).events.addEventListener(HabboFriendListTrackingEvent.const_308,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_147)
            {
               if(var_147.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_248 != null)
                  {
                     _loc4_["null"] = var_248.flashVersion;
                     _loc4_["null"] = var_248.averageUpdateInterval;
                  }
         ...
         logError(var_1422.getLastErrorMessage());
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1385);
         }
