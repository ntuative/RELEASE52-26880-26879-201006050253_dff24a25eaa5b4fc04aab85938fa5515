package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_172.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_172.ssoTicket = var_114.ticket;
         var_114.removeEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_288,onParsedTicketFailure);
         var_114 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1454,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_172.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_111,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1454,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_172.habboConfiguration.getKey("use.sso","false") == "true")
            {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_114 = new SSOTicket(var_172.assets,_loc2_,_loc1_);
         var_114.addEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_288,onParsedTicketFailure);
      }
