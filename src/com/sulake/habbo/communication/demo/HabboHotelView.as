package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_678:IAssetLibrary;
      
      private var var_810:uint = 0;
      
      private var var_566:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_678.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_52)
         {
            if(_events != null)
            {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_52,hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = var_678.loadAssetFromFile("hotel_view_banner_" + var_810,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_36,bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_52,bannerLoadedHandler);
         }
         else
         {
            if(_events != null)
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_52,bannerLoadedCallbackHandler);
         }
         ++var_810;
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_52,hotelViewLoadedHandler);
      }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_678.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_36,hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_52,hotelViewLoadedHandler);
         }
         else
         {
            var_567 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_36,hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_52,hotelViewLoadedCallbackHandler);
         }
         ++var_810;
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_52,bannerLoadedCallbackHandler);
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_52,bannerLoadedHandler);
      }
