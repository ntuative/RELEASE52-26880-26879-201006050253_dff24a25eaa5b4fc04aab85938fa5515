package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1472:ILogger;
      
      private var var_1203:String;
      
      private var var_1779:String;
      
      private const const_1454:String = "fuselogin";
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_693 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_693);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1203,var_1779));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1454,"/");
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1454,"/");
      ...
      {
         var_693 = _habboConfiguration.getKey("sso.ticket",null);
         var_1203 = _habboConfiguration.getKey("flash.client.url","");
         var_1779 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_173 == null)
         {
         ...
         if(var_693 != null)
         {
            var_58.mode = HabboConnectionType.const_310;
            var_58.initConnection(HabboConnectionType.const_297);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1472 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_652);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_58.mode)
         {
            case HabboConnectionType.const_310:
               _loc6_ = "";
               ...
               var_1015 = _loc4_;
               var_173.loadBannerImage(_loc7_ + "?token=" + var_1015,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_835:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1359:
               var_575 = generateRandomHexString(30);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1015);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_58.mode = HabboConnectionType.const_835;
            }
         }
         var_58.initConnection(HabboConnectionType.const_297);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_116,onRoomSessionEnded);
      }
