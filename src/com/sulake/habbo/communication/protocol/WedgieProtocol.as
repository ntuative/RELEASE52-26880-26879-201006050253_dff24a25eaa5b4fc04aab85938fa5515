package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1237:uint = 1;
      
      public static const const_1244:uint = 2;
       
      
      private var var_920:IProtocolDecoder;
      
      private var var_1102:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1102 = new WedgieEncoder();
         var_920 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1237)
            {
               _loc4_.position = 0;
               _loc6_ = var_920.getID(_loc4_);
