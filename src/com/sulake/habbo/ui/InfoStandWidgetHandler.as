   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_157,onFigureUpdate);
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_157,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_360);
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1040);
            ...
            case RoomObjectCategoryEnum.const_40:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_328)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_906)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_225)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1226;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_876;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1224);
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_657);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_627);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_548);
         _loc1_.push(RoomWidgetUserActionMessage.const_441);
         _loc1_.push(RoomWidgetUserActionMessage.const_765);
         _loc1_.push(RoomWidgetUserActionMessage.const_715);
         _loc1_.push(RoomWidgetUserActionMessage.const_1436);
         _loc1_.push(RoomWidgetPetCommandMessage.const_680);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_441)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_714:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_918,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_253:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_657:
            ...
            case RoomWidgetUserActionMessage.const_378:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_627:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_548:
            ...
            case RoomWidgetUserActionMessage.const_441:
               ...
               break;
            case RoomWidgetUserActionMessage.const_765:
            ...
            case RoomWidgetPetCommandMessage.const_685:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_680:
