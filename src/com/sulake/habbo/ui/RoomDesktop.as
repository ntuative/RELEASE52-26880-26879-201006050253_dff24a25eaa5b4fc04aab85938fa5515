package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1361:Boolean = true;
      
      private var var_894:IHabboTracking;
      
      private var var_56:Map;
      
      private var var_895:IHabboHelp = null;
      ...
      private var var_893:IRoomWidgetFactory = null;
      ...
      private var var_637:IAvatarRenderManager = null;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_350,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_472,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_767,onRoomContentLoaded);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_30.roomId,var_30.roomCategory,var_283[0],_loc2_.width,_loc2_.height);
      ...
      public function init() : void
      {
         ...
         {
            var_772 = _roomEngine.loadRoomResources(var_30.roomResources);
            if(false)
            {
               var_1362 = false;
         ...
         {
            var_1361 = !var_268.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_436 != null)
         {
            ...
            {
               _loc6_ = var_436.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_279,processEvent);
         }
         _friendList = null;
         var_179.dispose();
         var_179 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_350,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_472,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_767,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_893 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2208);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_436.length)
         {
            _loc2_ = var_436.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_893.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = var_628.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     var_628.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.ROOM_OBJECT_SELECTED:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_337,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_744 != null && _loc3_ == RoomObjectCategoryEnum.const_40)
               {
                  _loc7_ = var_30.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_328)
                  {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = var_628.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = _roomEngine.getRoomNumberValue(var_30.roomId,var_30.roomCategory,RoomVariableEnum.const_733);
            _loc14_ = _roomEngine.getRoomNumberValue(var_30.roomId,var_30.roomCategory,RoomVariableEnum.const_630);
            _loc15_ = _roomEngine.getRoomNumberValue(var_30.roomId,var_30.roomCategory,RoomVariableEnum.const_532);
            _loc16_ = _roomEngine.getRoomNumberValue(var_30.roomId,var_30.roomCategory,RoomVariableEnum.const_564);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_269,canvasMouseHandler);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_30 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  trackZoomTime(_loc2_.isZoomedIn());
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_316);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_416:
               ...
               var_180 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_318,WindowStyle.const_344,WindowParam.const_92) as IToolTipWindow;
               var_180.setParamFlag(WindowParam.const_49,false);
      ...
      {
         if(var_18 != null && var_30 != null && var_1361 && var_1362)
         {
            var_18.startSession(var_30);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_294));
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - var_1360) / 1000);
            if(var_894 != null)
            {
               if(param1)
               {
                  var_894.track("zoomEnded","in",_loc3_);
               }
               else
               {
                  var_894.track("zoomEnded","out",_loc3_);
               }
            }
            var_1360 = _loc2_;
         }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_279,processEvent);
         }
      }
