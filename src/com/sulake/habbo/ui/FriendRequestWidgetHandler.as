package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_719);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_629);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_649);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_279:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_719:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_629:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_649:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_279);
         return _loc1_;
      }
