   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_942,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_408,onHelpTutorialEvent);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_872,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1006,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_408,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_115:
               ...
               break;
            case HabboHelpTutorialEvent.const_408:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_506));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_675);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_545);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_648);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_531);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_562);
         _loc1_.push(RoomWidgetStopEffectMessage.const_570);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_359);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1396);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_868);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_621);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_565);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_593);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1345);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_534);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_581);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_762);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_565:
               ...
               break;
            case RoomWidgetWaveMessage.const_675:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_604:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_545:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_562:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1054)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_223,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_531:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_926:
                        _catalog.openCatalogPage(CatalogPageName.const_1214,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_896:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1427:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1263:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_648:
            case RoomWidgetStopEffectMessage.const_570:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_892:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1410:
                     break;
                  default:
            ...
            case RoomWidgetToolbarMessage.const_716:
               ...
               if(_toolbar)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_623:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_446,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_359:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_500));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_593:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_342,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_581:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_342,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_762:
               if(false && _container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_331:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_550));
               break;
            default:
