package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1737:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1739:String = "level";
      
      private var var_107:IItemListWindow;
      
      private const const_1743:String = "energy";
      
      private var var_1374:Map;
      
      private const const_1738:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1740:uint = 3355443;
      
      private var var_224:IBorderWindow;
      
      private const const_1736:int = 158;
      ...
      private const const_1741:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_224 != null)
         {
            var_107 = var_224.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_107 == null || var_224 == null || var_64 == null)
         {
            return;
         }
         ...
         var_224.height = NaN;
         _window.width = Math.max(var_224.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1374.getValue(var_622) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1739,param1.level,param1.levelMax);
         updateStateElement(const_1742,param1.experience,param1.experienceMax);
         updateStateElement(const_1743,param1.energy,param1.energyMax);
         updateStateElement(const_1738,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_622 = param1.id;
         var_1374.remove(param1.id);
         var_1374.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_185 && var_185.getPetId() == var_622)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_507,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1736,const_1735,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1741);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1740);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1737);
         return _loc5_;
      }
