   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_947 = _window.findChildByName("effect_hilite");
            var_947.visible = false;
         }
         var_946 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_945 = _window.findChildByName("loader_bar");
         if(var_945 != null)
         {
            var_434 = var_945.width;
            var_178.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_946 != null)
         {
            var_946.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_946.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
