package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_515:int = 25;
      ...
      private static const const_1071:int = 25;
      
      private static const const_1067:int = 1;
      
      private static const const_367:int = 9;
      
      private static const const_516:int = 8;
      
      private static const const_368:int = 0;
      
      private static const const_774:int = (const_516 + const_368) * const_105 + const_105;
      ...
      private var var_573:int = 18;
      
      private var var_342:IItemListWindow;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_1760 = param5;
         var_39 = param1.createWindow("chat_container","",HabboWindowType.const_57,HabboWindowStyle.const_43,HabboWindowParam.const_41,new Rectangle(0,0,200,var_192 + RoomChatHistoryPulldown.const_80),null,0) as IWindowContainer;
         var_39.background = true;
         var_39.color = 33554431;
         var_39.tags.push("room_widget_chat");
         var_342 = param1.createWindow("chat_contentlist","",HabboWindowType.const_914,HabboWindowStyle.const_41,0 | 0,new Rectangle(0,0,200,var_192),null,0) as IItemListWindow;
         var_39.addChild(var_342);
         var_126 = param1.createWindow("chat_active_content","",HabboWindowType.const_57,HabboWindowStyle.const_41,HabboWindowParam.const_73,new Rectangle(0,0,200,var_192),null,0) as IWindowContainer;
         var_342.addListItem(var_126);
         var_26 = new RoomChatHistoryViewer(this,param1,var_39,param2);
         var_1762 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_192 = const_774 + const_367;
         var_39.height = var_192 + var_26.pulldownBarHeight;
         var_342.width = 0 - 0;
         var_342.height = var_192;
         var_126.width = 0 - 0;
         if(historyViewerActive())
         {
            var_126.height = getTotalContentHeight() + const_367;
         }
         else
         {
            var_126.height = var_192;
         }
         var_342.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      private function processBuffer() : void
      {
         ...
         while(var_67.length > const_1067 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_690 = getTimer() + const_772;
         }
         else
         {
            if(false && false)
            {
               var_573 = getItemSpacing(_itemList["-1"],var_67[0]);
            }
            else
            {
               var_573 = const_105;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_688.x) * var_823;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_773;
         var _loc6_:Number = 0 + const_773 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1197 && !historyViewerActive())
         {
            resetArea();
            var_1197 = false;
         }
      ...
      {
         return "chat_" + var_1760.toString() + "_item_" + (var_1761++).toString();
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_395)
         {
            _loc2_ = param1 / const_1071 * const_1068;
            if(_loc2_ + var_689 > var_573)
            {
               _loc2_ = var_573 - var_689;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1467 == 0)
            {
               var_1467 = param1.scale;
            }
            else
            {
               var_823 = param1.scale / var_1467;
            }
         }
         if(param1.positionDelta != null)
         {
            var_688.x += param1.positionDelta.x / var_823;
            var_688.y += param1.positionDelta.y / var_823;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1762)
         {
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_516 + const_368 + 2)
               {
                  _loc1_.aboveLevels = const_516 + const_368 + 2;
               }
               var_481 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_192 = param1 - 0;
         var_39.height = var_192 + RoomChatHistoryPulldown.const_80;
         if(var_26 != null)
         {
            var_26.containerResized(var_39.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_332,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_613,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_368 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1069)
               {
