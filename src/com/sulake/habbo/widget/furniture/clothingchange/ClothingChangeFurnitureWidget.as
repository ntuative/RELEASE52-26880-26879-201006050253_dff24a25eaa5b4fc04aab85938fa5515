package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_797:String = "Girl";
      
      private static const const_796:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1007,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_317,onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1758 = param1.objectCategory;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1007,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_317,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_603 = _loc4_;
         var_603.offset(100,100);
         var _loc6_:IWindow = var_603.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_331,param1,var_165,var_1758,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_603 != null)
         {
            _loc1_ = var_603 as IFrameWindow;
            if(_loc1_ != null)
            {
