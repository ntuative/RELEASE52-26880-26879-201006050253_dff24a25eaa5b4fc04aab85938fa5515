package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_447.destroyGridItems();
         var_328 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1381) as IWindowContainer;
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_780.width,var_780.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_780,var_780.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_447.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_447.numGridItems)
         {
            return;
         }
         select(var_447.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_780 = BitmapData(_loc3_.content);
      }
