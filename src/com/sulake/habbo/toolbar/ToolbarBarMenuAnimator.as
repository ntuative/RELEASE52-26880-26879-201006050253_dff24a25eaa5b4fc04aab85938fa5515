package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1068:Number = 90;
      
      private static const const_822:int = 50;
      
      private static const const_1071:Number = 25;
      
      private static const const_1157:int = 50;
      ...
      private var var_1125:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1125 = param2;
         var_639 = new Timer(const_1071);
         var_639.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      {
         return var_537[var_538.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1125.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1125.getIconLoc(param1.iconId);
      ...
      {
         return var_538[var_537.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_638[_loc3_] = new Array();
            }
            if(var_638[_loc3_].indexOf(param1) < 0)
            {
               var_638[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_822 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_822 || param1.desktop.height - param1.y < const_1157;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_538[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_638[_loc3_].length)
                  {
                     repositionWindow(var_638[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
