package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_942,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_168,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_175,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_50,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_446,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_590,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_860,onHideWindowEvent);
         var_37 = true;
