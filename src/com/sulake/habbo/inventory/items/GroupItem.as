package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1716:int = 13421772;
      ...
      protected var var_2334:BitmapData;
      
      protected var var_980:Boolean;
      ...
      private const const_1715:int = 8947848;
      ...
      private const const_1450:Number = 0.2;
      
      protected var var_1430:Boolean;
      
      private const const_1451:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_547)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1616));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1450;
               _loc1_.blend = const_1450;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1430 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2334;
               _loc5_.visible = true;
            }
            else
            {
