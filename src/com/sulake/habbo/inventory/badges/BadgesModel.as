package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1745:int = 5;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_288[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_288.length)
               {
                  if((var_288[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_288[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_379.getBadgeImage(param1);
            var_288.push(_loc8_);
            if(param2)
            {
