package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private var var_1374:PetData;
      
      private var _window:IWindowContainer;
      
      private var var_1087:PetsView;
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_55:
               var_1087.setSelectedGridItem(this);
               var_908 = true;
               break;
            ...
            case WindowMouseEvent.const_33:
               ...
               {
                  var_908 = false;
                  var_1087.placePetToRoom(var_1374.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1715) : uint(const_1716);
      }
