package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1329 && param1.type == RoomEngineObjectEvent.const_241)
         {
            var_29.showView();
            var_1329 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1329 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_40,RoomObjectTypeEnum.const_312,_loc3_.figure);
            var_29.closeView();
            return;
         }
