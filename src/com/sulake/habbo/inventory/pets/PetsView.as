package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      private var var_506:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_506 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_650 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_650.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_328 != null)
         {
            var_328.setSelected(false);
         }
         var_328 = param1;
         if(var_328 != null)
         {
            var_328.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_328.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_650.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_506.removeGridItem(_loc2_.window);
         if(var_328 == _loc2_)
         {
            var_328 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_650.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_506.addGridItem(_loc2_.window);
            var_650.add(param1.id,_loc2_);
            if(var_328 == null)
            {
               selectFirst();
            }
