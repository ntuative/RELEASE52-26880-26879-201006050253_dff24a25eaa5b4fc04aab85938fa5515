package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_116,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_768));
      }
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_147));
      }
      ...
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_358));
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_251));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_379 = ISessionDataManager(param2);
      ...
      {
         return var_47.getValue(InventoryCategory.const_352) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1034 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_285));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_116,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_352,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_379);
         var_47.add(InventoryCategory.const_285,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_768,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_379);
         var_47.add(InventoryCategory.const_358,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_251,_loc8_);
         ...
         var_47.add(InventoryCategory.const_147,_loc10_);
