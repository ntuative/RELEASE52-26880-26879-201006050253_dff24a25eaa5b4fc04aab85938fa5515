package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1585 = new Vector3d();
         var_1584 = new Vector3d();
         var_515 = new Array(param2);
      ...
      {
         var_1584.assign(var_239);
         return var_1584;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_515.length)
         {
            if(var_515[param2] != param1)
            {
               var_515[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_515.length)
         {
