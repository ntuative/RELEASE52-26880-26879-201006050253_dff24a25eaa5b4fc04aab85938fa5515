package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_477:IRoomObjectFactory = null;
      
      private var var_1007:int;
      
      private var var_2439:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_476 = [];
         var_478 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_350,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_472,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_767,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_37 == const_1231)
         {
            if(var_820 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_477.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_477 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_477 != null)
         {
            return var_477.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_477.createRoomObjectLogic(_loc18_);
