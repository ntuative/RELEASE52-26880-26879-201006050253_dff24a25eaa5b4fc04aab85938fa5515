package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1453:int = 50;
      ...
      private var var_1727:Number = -1.0E7;
      
      private var var_1726:Number = -1.0E7;
      
      private var var_2420:int = 0;
      
      private var var_474:RoomObjectCache;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_294 = new Map();
         var_474 = new RoomObjectCache(_loc6_);
      ...
      {
         var_474.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_812 == 0)
         {
            checkMouseHits(var_999.x,var_999.y,MouseEvent.MOUSE_MOVE);
         }
         var_812 = 0;
         ++var_1459;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_52.graphics.beginFill(var_2420);
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - var_680 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_681 != var_1729 || var_680 != var_1730)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         {
            ...
            if(_loc7_ != null)
            {
               _loc6_ = _container.method_6(_loc4_);
               _loc5_ += renderObject(_loc7_,_loc6_,param1,_loc9_,_loc5_);
            }
            _loc4_++;
         }
         var_390.sortOn("z",0 | 0);
         if(_loc5_ < var_390.length)
         {
            var_390.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_390[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(var_475 != null)
         {
            ...
            {
               cleanSprite(var_475[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_475 = [];
         }
         ...
         while(_loc1_ < var_294.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1000 != null)
                  {
                     var_1000.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1459,geometry);
                  }
                  else
                  {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_999.x = param1;
         var_999.y = param2;
         if(var_812 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1460;
         }
         var_1460 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_812;
         return var_1460;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1727 || param2 != var_1726)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_475.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_474.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_474.getObjectCache(param2);
         ...
         _loc13_ += int(var_681 / 2);
         _loc14_ += int(var_680 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_681 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_680))
                  {
