package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_978:MouseEventQueue;
      
      public static var var_1665:IMouseCursor;
      ...
      public static var var_1428:KeyboardEventQueue;
      ...
      protected var var_2346:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_742:WindowController;
      
      private var var_674:Date;
      
      protected var var_2348:IWindowParser;
      
      protected var var_986:Error;
      
      protected var var_2347:IInternalWindowServices;
      
      protected var var_99:WindowController;
      
      protected var var_1441:int = -1;
      
      protected var var_90:IDesktopWindow;
      
      private var var_1555:Boolean = false;
      
      protected var var_2433:Boolean = true;
      
      private var var_189:Boolean = false;
      
      protected var var_1154:SubstituteParentController;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_330 = param5;
         var_2347 = new InternalWindowServices(this,param5);
         var_2346 = param3;
         var_2348 = new WindowParser(this);
         var_674 = new Date();
         if(var_1064 == null)
         {
         ...
         if(var_978 == null)
         {
            var_978 = new MouseEventQueue(param5);
         }
         if(var_1428 == null)
         {
            var_1428 = new KeyboardEventQueue(param5);
         }
         if(param6 == null)
         {
         ...
         var_1154 = new SubstituteParentController(this);
         var_375 = param7;
      }
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1304,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc7_:MouseEventQueue = WindowContext.var_978;
         _loc7_.begin();
         var_615.x = -1;
         var_615.y = -1;
         while(true)
         {
            ...
            if(_loc2_.stageX != var_615.x || _loc2_.stageY != var_615.y)
            {
               var_615.x = _loc2_.stageX;
               var_615.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_90.groupChildrenUnderPoint(var_615,_loc5_);
            }
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1665 == null)
         {
            var_1665 = new MouseCursorControl(var_330);
         }
         return var_1665;
      }
