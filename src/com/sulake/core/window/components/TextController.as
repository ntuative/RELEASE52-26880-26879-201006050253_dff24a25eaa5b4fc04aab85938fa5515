package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2419:Rectangle = new Rectangle();
      ...
      protected var var_558:String = "none";
      ...
      {
         return new Rectangle(var_662 * maxScrollH,var_382 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_799)
         {
            context.removeLocalizationListener(var_329,this);
         }
         if(var_69 != null)
         {
            var_69.dispose();
      ...
      {
         var_662 = param1;
         _field.scrollH = var_662 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_329 = param1;
         if(var_329.charAt(0) == "$" && var_329.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_329.slice(2,var_329.indexOf("}")),this);
            var_799 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_530,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_530,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_558,PropertyStruct.STRING,var_558 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_530,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_558 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_558 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_558 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_558 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
