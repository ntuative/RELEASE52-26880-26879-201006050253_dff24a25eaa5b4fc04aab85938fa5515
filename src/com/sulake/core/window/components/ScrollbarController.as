package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1165:String = "increment";
      
      private static const const_529:String = "slider_bar";
      
      private static const const_1166:String = "decrement";
      
      private static const const_826:String = "slider_track";
      ...
      {
         return findChildByName(ScrollbarController.const_826) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_961 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_961 != null)
         {
            _loc1_ = findParentByName(var_961) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_961) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1165)
            {
               if(var_21)
               {
                  var_651 = true;
            ...
            else if(param2.name == ScrollbarController.const_1166)
            {
               if(var_21)
               {
                  var_651 = true;
            ...
            else if(param2.name == ScrollbarController.const_826)
            {
               _loc4_ = new Point();
