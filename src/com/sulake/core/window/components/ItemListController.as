package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1061:String = "resize_on_item_update";
      
      protected static const const_1059:String = "spacing";
      
      protected static const const_1442:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1060:String = "scale_to_fit_items";
      ...
      protected var var_2418:Number = 0.0;
      
      protected var var_562:Boolean = false;
      
      protected var var_2417:Number = 0.0;
      ...
      protected var var_800:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_92 = 0;
         var_70 = 0;
         _horizontal = param2 == WindowType.const_319;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_166 = var_661 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_353,WindowStyle.const_344,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_497,containerEventHandler);
      ...
      {
         return new Rectangle(var_560 * maxScrollH,var_561 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_497,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != var_560)
         {
            ...
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_81);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1059,_spacing,PropertyStruct.const_65,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1058,var_800,PropertyStruct.const_64,var_800 != const_1443));
         _loc1_.push(new PropertyStruct(const_1060,var_562,PropertyStruct.const_64,var_562 != const_1442));
         _loc1_.push(new PropertyStruct(const_1061,var_1155,PropertyStruct.const_64,var_1155 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_561 = param1;
            _container.y = -var_561 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_81);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1061:
                  ...
                  break;
               case const_1058:
                  var_800 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_395,param1);
            }
            else
            {
