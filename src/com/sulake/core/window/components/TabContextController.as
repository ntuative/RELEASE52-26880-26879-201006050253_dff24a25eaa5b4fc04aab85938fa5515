package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1084:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1669 == null)
         {
            var_1669 = findChildByTag(TabContextController.const_1083) as IWindowContainer;
         }
         return var_1669;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_984 == null)
         {
            var_984 = findChildByTag(TabContextController.const_1084) as ITabSelectorWindow;
            if(var_984 != null)
            {
               var_984.procedure = selectorEventProc;
            }
         }
         return var_984;
      }
      ...
      {
         return !!var_902 ? selector.iterator : null;
      }
