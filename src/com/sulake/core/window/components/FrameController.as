package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1078:String = "_HEADER";
      
      private static const const_777:String = "margin_right";
      
      private static const const_1079:String = "_SCALER";
      
      private static const const_1076:String = "_TITLE";
      
      private static const const_1077:String = "_CONTENT";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_778,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1202 == null)
         {
            var_1202 = findChildByTag(const_1078) as IHeaderWindow;
            if(!var_1202)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1076) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return content != null && var_667 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1077) as IWindowContainer;
            if(!var_20)
            {
