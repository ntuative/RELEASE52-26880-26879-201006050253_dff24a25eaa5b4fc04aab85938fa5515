   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_341)
         {
            ...
            if(var_341)
            {
               var_341.addEventListener(WindowEvent.const_265,scrollBarEventProc);
               var_341.addEventListener(WindowEvent.const_235,scrollBarEventProc);
            }
         }
         return var_341;
      }
      ...
      override public function dispose() : void
      {
         if(var_341)
         {
            var_341.removeEventListener(WindowEvent.const_265,scrollBarEventProc);
            var_341.removeEventListener(WindowEvent.const_235,scrollBarEventProc);
            var_341 = null;
         }
         if(var_813)
         {
