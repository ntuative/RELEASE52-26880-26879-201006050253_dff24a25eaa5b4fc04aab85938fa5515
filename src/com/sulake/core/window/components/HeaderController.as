package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1107:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1076) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1107) as IItemListWindow;
      }
   }
}
