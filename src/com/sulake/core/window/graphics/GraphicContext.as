package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_983:uint = 256;
      ...
      public static const const_1666:uint = 128;
      
      public static const const_1586:uint = 64;
      
      public static const const_708:uint = 4;
      
      public static const const_1350:uint = 0;
      
      public static const const_1184:uint = 16;
      
      public static const const_591:uint = 1;
      
      public static const const_1238:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1184:
               ...
               break;
            case GraphicContext.const_708:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_983:
               break;
            case GraphicContext.const_1350:
               break;
            default:
         ...
         if(var_666)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1671,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1671,16777215);
                  }
                  var_386 += bitmap.width * bitmap.height * 4;
               }
