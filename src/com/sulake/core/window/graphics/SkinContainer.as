package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_801:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_728 = new Dictionary();
         var_729 = new Dictionary();
         var_1525 = new Dictionary();
         var_1986 = new Dictionary();
         TypeCodeTable.fillTables(var_1525,var_1986);
         var_1266 = new Dictionary();
         var_1987 = new Dictionary();
         StateCodeTable.fillTables(var_1266,var_1987);
         var_497 = new Dictionary();
         var_497["skin"] = BitmapSkinRenderer;
         var_497["bitmap"] = BitmapDataRenderer;
         var_497["fill"] = FillSkinRenderer;
         var_497["text"] = TextSkinRenderer;
         var_497["shape"] = ShapeSkinRenderer;
         var_497["unknown"] = SkinRenderer;
         var_497["null"] = NullSkinRenderer;
         if(var_385 == null)
         {
            var_385 = new Array();
            var_385.push(WindowState.const_68);
            var_385.push(WindowState.const_76);
            var_385.push(WindowState.const_95);
            var_385.push(WindowState.WINDOW_STATE_SELECTED);
            var_385.push(WindowState.const_85);
            var_385.push(WindowState.const_79);
            var_385.push(WindowState.const_100);
            var_385.push(WindowState.const_87);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1266)
         {
            _loc3_.push(var_1266[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1525[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_728[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_728[param1] = new Array(SkinContainer.const_801);
         }
         var_728[param1][param2] = param3;
         if(true)
         {
            var_729[param1] = new Array(SkinContainer.const_801);
         }
         var_729[param1][param2] = param4;
      }
