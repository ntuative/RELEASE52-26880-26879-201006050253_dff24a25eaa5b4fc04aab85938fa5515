package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_806:uint = 2;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_880:
               var_758 = var_683.getTheActualState(param1.type,param1.style,param1.state);
               if(var_758 != var_1088)
               {
                  var_233 = true;
                  _loc4_ = true;
      ...
      {
         return var_683.getTheActualState(param1.type,param1.style,param1.state) != var_1088;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_806) : uint(const_519);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_758))
            {
               _loc5_ = const_807;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_807)
               {
                  ...
                  if(var_233)
                  {
                     ...
                     _loc7_.draw(param1,var_97,var_97.rect,var_758,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_35))
                  {
                     ...
                     _loc4_.draw(var_97,var_983,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_683.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_834)
            {
               _loc2_ = var_683.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_834);
            }
         }
         return _loc2_;
      }
