package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1600:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_411 = _loc13_.blend;
            var_557 = _loc13_.treshold;
            if(var_661 != _loc13_.background)
            {
         ...
         if(param7 != null)
         {
            ...
            if(var_17)
            {
               var_16.invalidate(this,var_8,WindowRedrawFlag.const_81);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_146);
      ...
      {
         var_661 = param1;
         var_556 = !!var_661 ? uint(var_556 | var_1438) : uint(var_556 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2150 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1028:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_485:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_862:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1348:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1357:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_399:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_763:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_859:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_640:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_80 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_491,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_591,var_8);
      ...
      {
         var_411 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_901);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1096 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         var_1438 = param1 & 4278190080;
         var_556 = !!var_661 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_81);
      }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_174:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_456,this,null));
                     if(testParamFlag(WindowParam.const_186,WindowParam.const_146))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_182,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_485:
                  var_16.invalidate(this,var_8.union(var_57),WindowRedrawFlag.const_409);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_999,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_270,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_326:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_763,this,null));
                     if(var_9 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_453:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_880);
                  break;
               case WindowNotifyEvent.const_491:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_399:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_409);
                     }
                  }
                  else if(_param & 0)
                  {
      ...
      {
         return var_665 != null ? var_665 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_640,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1096 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1028,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_748,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_485,this,null));
            }
            if(_loc6_)
            {
         ...
         if(var_166 && var_557 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1600,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1600,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_81);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               ...
               var_57.width = var_8.width;
               var_57.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_482,this,var_9));
            }
            else
            {
               var_316.x = 0;
               ...
               var_316.width = 0;
               var_316.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_859,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_665,properties,var_660.concat(),_id) as WindowController;
         ...
         _loc2_.var_1438 = var_1438;
         _loc2_.var_1151 = var_1151;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_487;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_37 == WindowState.const_490)
         {
            return true;
         }
