package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1629:String = "_INCLUDE";
      
      public static const const_1051:String = "_EXCLUDE";
      
      public static const const_1676:String = "_TEMP";
      ...
      protected var var_1149:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_981:Dictionary;
      
      protected var var_1432:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1150,var_1149);
         var_981 = new Dictionary();
         var_1431 = new Dictionary();
         ParamCodeTable.fillTables(var_981,var_1431);
         var_1432 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1064,"");
         return param1.replace(const_1063,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1149)
            {
               delete var_1149[_loc1_];
            }
            for(_loc1_ in var_981)
            {
               delete var_981[_loc1_];
            }
            for(_loc1_ in var_1431)
            {
               delete var_1431[_loc1_];
            }
            var_1432.dispose();
            var_1432 = null;
            var_16 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1051) == -1)
                  {
