package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1063:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_614:uint = 0;
      
      public static const const_658:String = "AssetLibraryReady";
      
      public static const const_1369:String = "AssetLibraryUnloaded";
      
      public static const const_393:String = "AssetLibraryLoaded";
      
      public static const const_1347:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         if(_sharedListOfTypesByMime == null)
         {
            ...
            method_2(new AssetTypeDeclaration("application/octet-stream",UnknownAsset,BinaryFileLoader));
            method_2(new AssetTypeDeclaration("application/x-shockwave-flash",DisplayAsset,BitmapFileLoader,"swf"));
            method_2(new AssetTypeDeclaration("application/x-font-truetype",ClassAsset,BinaryFileLoader,"ttf"));
            method_2(new AssetTypeDeclaration("application/zip",UnknownAsset,ZipFileLoader,"zip"));
            method_2(new AssetTypeDeclaration("text/xml",XmlAsset,BinaryFileLoader,"xml"));
            method_2(new AssetTypeDeclaration("text/html",XmlAsset,BinaryFileLoader,"htm","html"));
            method_2(new AssetTypeDeclaration("text/plain",TextAsset,BinaryFileLoader,"txt"));
            method_2(new AssetTypeDeclaration("image/jpeg",BitmapDataAsset,BitmapFileLoader,"jpg","jpeg"));
            method_2(new AssetTypeDeclaration("image/gif",BitmapDataAsset,BitmapFileLoader,"gif"));
            method_2(new AssetTypeDeclaration("image/png",BitmapDataAsset,BitmapFileLoader,"png"));
            method_2(new AssetTypeDeclaration("image/tiff",BitmapDataAsset,BitmapFileLoader,"tif","tiff"));
            method_2(new AssetTypeDeclaration("sound/mp3",SoundAsset,SoundFileLoader,"mp3"));
         }
         ++var_614;
      ...
      public function unload() : void
      {
         ...
         var_307 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1369));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_505)
         {
            AssetLibrary.fetchLibraryContents(this,var_504,var_352);
         }
         var_307 = true;
         dispatchEvent(new Event(AssetLibrary.const_393));
         dispatchEvent(new Event(AssetLibrary.const_658));
         if(var_505)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_52,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_991,assetLoadEventHandler);
      ...
      public function method_2(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1063.splice(var_1063.indexOf(this),1);
            --var_614;
            var_417 = null;
            var_741 = null;
            var_139 = null;
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_52,e.status);
                     break;
                  }
                  if(true)
                  {
               ...
               break;
            case AssetLoaderEvent.const_52:
               remove = true;
         }
