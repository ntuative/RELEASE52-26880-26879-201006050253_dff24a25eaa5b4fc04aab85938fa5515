package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_31 = new Array();
         var_559 = new Array();
         var_982 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_461 = new AssetLibrary("lib-" + var_668++);
         var_31.push(var_461);
      }
      ...
      {
         return var_461.method_2(param1,param2);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            loaderContext = var_982;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + var_668++);
         var_559.push(_loc3_);
