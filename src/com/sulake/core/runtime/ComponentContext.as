   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1179);
            }
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_289.length)
         {
            _loc10_ = var_289[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      public final function detachComponent(param1:Component) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_289.length)
         {
            if(var_289[_loc4_] == param1)
            {
               var_289.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
