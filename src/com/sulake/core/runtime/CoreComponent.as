package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1118:String = "zip-libraries";
      ...
      private static const const_1116:String = "service-libraries";
      
      private static const const_1117:String = "library";
      
      private static const const_1119:String = "component-libraries";
       
      
      private var var_732:IEventDispatcher;
      
      private var var_882:Profiler;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1366:
               ...
               var_882 = new Profiler(this);
               attachComponent(var_882,[new IIDProfiler()]);
               var_731 = new ProfilerViewer();
               var_216.addChild(var_731);
               break;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1205);
         if(!_isDisposed)
         {
      ...
      {
         return var_231 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         if(var_732)
         {
            var_732.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,param1.bytesLoaded,param1.bytesTotal));
         }
      }
         ...
         while(criticality < CoreComponent.const_144)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_882.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_732)
         {
            var_732.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_732)
               {
                  var_732.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,var_231 - 0,var_231));
               }
            }
         }
         if(false)
