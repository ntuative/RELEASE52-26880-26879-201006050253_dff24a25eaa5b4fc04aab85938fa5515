package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_950:uint = 4;
      ...
      protected var var_2048:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_986 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_986);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1157 & const_950)
         {
            if(_loc3_ == 0)
            {
